/* 
        map_overwrite_subtableheader.c
...
int map_overwrite_subtableheader(const subtableheader_t *subtableheader, size_t nbytes, int fd, pointer_t offset)
 
{
    ...
    retval = map_overwrite(my_subtableheader, nbytes, fd, offset);
