...
int map_write_nametable(const nametable_t *nametable, size_t nbytes, int fd, pointer_t *adr)
 
{
    ...
    retval = map_write(my_nametable, nbytes, fd, adr);
