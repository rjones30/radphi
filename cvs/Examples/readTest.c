/*
  $Log: readTest.c,v $
  Revision 1.2  2014/06/06 21:51:05  radphi
  ...
  * ntuple.c [rtj]
  ...
  Revision 1.1  1998/03/30 19:27:09  radphi
  Initial revision by jonesrt@
  a simple test program to test the event reading library - R.T.Jones
