 ...
 *
 *   Revision 1.1  1997/01/31 16:35:29  lfcrob
 *   Initial revision
 *
...
static char rcsid[] = "$Id: swap_util.c,v 1.2 2003/03/04 19:37:19 radphi Exp $";
...
static evStack *init_evStack(void),*evStack_top(evStack *head);
 ...
 *********************************************************/
static evStack *init_evStack(void)
{
  evStack *evhead;
