 ...
 *
 *
 *      modified by R.T. Jones, July 29 2000
 *       - left a few colors free so the window can set its
 *         canvas and menus background colors.  This is silly,
 *         but did these authors really need all 256 of them???
 *         To do this I set upfrontcolors less than 80.
 *
 */
#ifdef HVNT
#define WIN32 1
