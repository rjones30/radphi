...
{
  Hv_hotFont = (short)((intptr_t)data);    /* this will be the item selected */
}
...
{
  Hv_hotSymbol = (short)((intptr_t)data);    /* this will be the item selected */
}
...
{
  Hv_hotFontFamily = (short)((intptr_t)data);    /* this will be the item selected */
}
...
{
  Hv_hotFontSize = (short)((intptr_t)data);    /* this will be the item selected */
}
...
{
  Hv_hotFontStyle = (short)((intptr_t)data);    /* this will be the item selected */
}
...
{
  Hv_hotStyle = (short)((intptr_t)data);    /* this will be the item selected */
}
...
static void Hv_DoArrowStylePopupMenu(Hv_Widget	w,
				 Hv_Pointer	data)
{
  Hv_hotArrowStyle = (short)((intptr_t)data);
}
