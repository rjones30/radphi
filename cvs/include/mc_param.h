...
#ifndef MC_PARAM_H_INCLUDED
#define MC_PARAM_H_INCLUDED
...
#define DECAY_THETA_REAL_PHI 0x40
...
#define GEOM_CEBAF_328 0x10
#define GEOM_CEBAF_620 0x20
...
typedef struct{
  mc_reaction_t reaction;
  mc_beam_t beam;
  mc_transfer_t transfer;
  mc_codes_t codes;
} mc_param_t;
...
int initParam(char *);
int loadParam(mc_param_t *param,particles_db_t **db);
