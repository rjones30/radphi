/*
 * $Id: timel.c,v 1.1 2001/10/13 00:32:53 radphi Exp $
 *
 * $Log: timel.c,v $
 * Revision 1.1  2001/10/13 00:32:53  radphi
 * added timel.c to correct a buggy version in 2001 cernlib release -rtj-
 *
